...
Tags: multi step checkout, multistep woocommerce, step-by-step checkout, steps checkout, woocommerce, woocommerce checkout, woocommerce, onepage checkout, multistep checkout
...
With WooCommerce MultiStep Checkout Wizard Lite you can change default WooCommerce Checkout page to the modern and easy step-by-step checkout.
Most rated ecommerce stores using it and their customers are happy to do fast purchase with multi-step form wizard. 

**For more features and amazing quick support get MultiStep Checkout Wizard PRO version:**

*  Customize colors each steps element
...
<a href="http://codecanyon.net/item/woocommerce-multistep-checkout-wizard-pro/8674984?ref=Festi-Team">Download the PRO version here</a>

<a href="http://codecanyon.net/item/woocommerce-multistep-checkout-wizard-pro/8674984?ref=Festi-Team"><img class="alignnone size-full wp-image-15" src="http://wp4.test.festi.io/wp-content/uploads/2014/09/buttons.png" alt="buttons" width="224" height="70" /></a>
